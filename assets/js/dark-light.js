  ...
  null !== (e = document.querySelector('[data-bs-toggle="mode"]')) &&
    ((t = e.querySelector("#theme-mode-btn")),
      ...
      e.addEventListener("click", function (e) {
        t.checked ? (root.setAttribute("data-bs-theme", "light"), window.localStorage.setItem("mode", "light")) : (root.removeAttribute("data-bs-theme", "light"), window.localStorage.setItem("mode", "light"));
      }))
})(jQuery);
